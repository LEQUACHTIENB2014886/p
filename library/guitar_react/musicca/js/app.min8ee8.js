    ...
    (p = {
      toggleButtonContentUniversal: function (t, e) {
        t.classList.contains("active")
          ? (e && (t.firstElementChild.innerHTML = e.default),
            t.classList.remove("active"))
          : (e && (t.firstElementChild.innerHTML = e.active),
      ...
      toggleContentHeight: function (t, e) {
        if (t.classList.contains("active")) {
          ...
          e.style.height = o + "px";
        } else e.style.height = "0px";
      },
      methodsExists: function (t, e) {
        if (e === n || t === n) return !1;
        "string" != typeof t || (t = [t]);
        for (var o = 0; o < t.length; o++) if (n === e[t[o]]) return !1;
        return !0;
      },
      debug: function (e, o) {
        p.methodsExists(["log", "dir"], t.console) &&
          (("string" == typeof o && t.console.log(o), "string" == typeof e)
            ? t.console.log(e)
            : t.console.dir(e));
      },
      ...
      scrollingUp: function (t) {
        var e = !1;
        return t < h && (e = !0), console.log(h), (h = t), e;
      },
      removeModal: function (t) {
        t.preventDefault(), o(".modal").remove();
      },
      mobMenuInit: function (t) {
        var e = t.find(".mobile__menu");
        o(".mobile_menu__item.current")
          .parents(".mobile_menu__item")
          .addClass("active"),
          e.find(".active > ul").show(),
          e
            .find(".active > .mobile_submenu__toggle .fa-angle-down")
      ...
      mobMenuShow: function (t) {
        a.addClass("menu-mobile-active"),
          t
            .find(".menu_toggle__open")
            .removeClass("menu_toggle__open")
            .addClass("menu_toggle__close"),
          t.find(".mobile__menu").slideDown(),
          t.parent().find(".navigation__account").removeClass("arrow"),
          t
            .parent()
            .parent()
            .find(".navigation__account__menu")
            .stop()
            .slideUp(),
      ...
      mobMenuHide: function (t) {
        a.removeClass("menu-mobile-active"),
          t
            .find(".menu_toggle__close")
            .removeClass("menu_toggle__close")
            .addClass("menu_toggle__open"),
      ...
      mobSubmenuShow: function (t) {
        ...
        for (var s = 0; s < n.length; s++) p.mobSubmenuHide(n.eq(s));
      },
      ...
      mobMenuClick: function (t) {
        ...
        o.hasClass("active") &&
          (e.body.classList.remove("lang-open"),
      ...
      smoothScroll: function () {
        if (
          ...
          var e = this.hash,
            n = o(this.hash);
          if (
            (n = n.length ? n : o("[name=" + this.hash.slice(1) + "]")).length
          )
            return (
              p.isDesktop()
                ? o("html,body").animate(
      ...
      onAgeChange: function () {
        ...
        function r(t) {
          if (s(t)) {
            n.slideUp(), e.attr("disabled", !0);
            return;
          }
          n.slideDown(), e.attr("disabled", !1);
        }
      ...
      changeLocationHref: function () {
        ...
        e.includes("#_=_") &&
          ((e = e.replace("#_=_", "")),
          history.pushState({ param: "Value" }, "", e));
      },
      initFirefoxStyle: function () {
        console.log("initFirefoxStyle"),
          jQuery(".form-select").css({ padding: 0, "text-indent": "6px" });
      },
      domReady: function () {
        l.settings.isMobile
          ? a.addClass("is-mobile")
          : a.addClass("is-desktop");
        var t = o("#navigation-mobile");
        p.mobMenuInit(t),
          ...
          o(".navigation__account").click(function () {
            ...
            (a.hasClass("menu-mobile-active") || e.hasClass("arrow")) &&
              (p.mobMenuHide(t),
              o(this).parent().find(".mobile__search").removeClass("arrow"),
              o(this)
                .parent()
                .parent()
                .find(".mobile__searchfield")
                .stop()
                .slideUp()),
              o(this).hasClass("arrow")
                ? (o(this).removeClass("arrow"),
                  o(this)
                    .parent()
                    .parent()
                    .find(".navigation__account__menu")
          ...
          -1 != navigator.userAgent.indexOf("Firefox") &&
            (console.log(-1 != navigator.userAgent.indexOf("Firefox")),
            p.initFirefoxStyle()),
  ...
  jQuery(document).ready(function () {
    var t = jQuery(document.body),
      ...
      o = document.querySelector(
        ".navigation__mobile .lang_button .current-lang"
      ),
    ...
    t.on("click", function (e) {
      if (t.hasClass("lang-open")) {
        for (var s = jQuery(e.target); "BODY" != s.prop("tagName"); ) {
          if (s.hasClass("current-lang")) return;
          s = s.parent();
        }
      ...
      l = function (t) {
        ...
        return (
          (0 == e
            ...
            ? "0" + e + ":"
            : e + ":") +
          (o.toString().length < 2 ? "0" + o : o) +
          ":" +
          (n.toString().length < 2 ? "0" + n : n)
        );
      },
      p = function (t) {
        ...
        return !!(
          e.canPlayType &&
          e
            .canPlayType("audio/" + t.split(".").pop().toLowerCase() + ";")
            .replace(/no/, "")
        );
      };
    t.fn.audioPlayer = function (e) {
      var e = t.extend(
          { classPrefix: "audioplayer", strPlay: "Play", strPause: "Pause" },
          e
        ),
        o = {},
        n = {
      ...
      for (var d in n) o[d] = e.classPrefix + "-" + n[d];
      return (
        this.each(function () {
          ...
          var g = t(
              '<div class="' +
                ...
                '">' +
                (f
                  ? t("<div>").append(n.eq(0).clone()).html()
                  : '<embed src="' +
                    d +
            ...
            m = m.get(0);
          if (f) {
            g.find("audio").css({ width: 0, height: 0, visibility: "hidden" }),
              g.append(
                '<div class="' +
                  o.time +
                  " " +
            ...
            var v = g.find("." + o.bar),
              ...
              x = function (t) {
                (theRealEvent = s ? t.originalEvent.touches[0] : t),
                  (m.currentTime = Math.round(
                    (m.duration * (theRealEvent.pageX - v.offset().left)) /
                      v.width()
                  ));
              },
              C = function () {
                isNaN(m.duration)
                  ? b.width("0%")
                  : b.width((m.buffered.end(0) / m.duration) * 100 + "%");
              };
            _.html("&hellip;"),
              w.text(l(0)),
          ...
          } else g.addClass(o.mini);
          u && g.addClass(o.playing),
            g.find("." + o.playPause).on("click", function () {
              return (
                g.hasClass(o.playing)
                  ? (t(this).attr("title", e.strPlay).find("a").html(e.strPlay),
                    g.removeClass(o.playing),
                    f ? m.pause() : m.Stop())
                  : (t(this)
                      .attr("title", e.strPause)
                      .find("a")
                      .html(e.strPause),
  ...
  Opentip = (function () {
    function t(e, o, n, s) {
      ...
      for (
        this.loaded = !1,
          ...
          this.dimensions = { width: 100, height: 50 },
          this.content = "",
          this.redraw = !0,
          ...
          "object" == typeof o
            ? ((s = o), (o = n = void 0))
            : "object" == typeof n && ((s = n), (n = void 0)),
          null != n && (s.title = n),
          null != o && this.setContent(o),
          null == s.extends &&
            (null != s.style
              ? (s.extends = s.style)
              : (s.extends = t.defaultStyle)),
          l = [s],
          b = s;
        b.extends;

      ) {
        if (((d = b.extends), null == (b = t.styles[d])))
          throw Error("Invalid style: " + d);
        l.unshift(b),
          null == b.extends && "standard" !== d && (b.extends = "standard");
      }
      for (
        (s = (m = this.adapter).extend.apply(
          m,
          [{}].concat(__slice.call(l))
        )).hideTriggers = (function () {
          var t, e, o, n;
          for (n = [], t = 0, e = (o = s.hideTriggers).length; t < e; t++)
            (a = o[t]), n.push(a);
          return n;
        })(),
          s.hideTrigger &&
            0 === s.hideTriggers.length &&
            s.hideTriggers.push(s.hideTrigger),
          u = 0,
          f = (v = ["tipJoint", "targetJoint", "stem"]).length;
        u < f;
        u++
      )
      ...
      for (
        !s.ajax ||
          ...
          ("A" === this.adapter.tagName(this.triggerElement)
            ? (s.ajax = this.adapter.attr(this.triggerElement, "href"))
            : (s.ajax = !1)),
          "click" === s.showOn &&
            "A" === this.adapter.tagName(this.triggerElement) &&
          ...
          null == s.delay && (s.delay = "mouseover" === s.showOn ? 0.2 : 0),
          null == s.targetJoint &&
          ...
          null != s.ajaxCache && ((s.cache = s.ajaxCache), delete s.ajaxCache),
          this.options = s,
          this.bound = {},
          c = 0,
          g = (y = [
      ...
      this.adapter.domReady(function () {
        if ((w.activate(), "creation" === w.options.showOn))
    ...
    return (
      ...
      (t.prototype._setup = function () {
        ...
        for (
          this.debug("Setting up the tooltip."),
            ...
            this.hideTriggers = [],
            n = s = 0,
            a = (l = this.options.hideTriggers).length;
          s < a;
          n = ++s
        ) {
          if (
            ...
            (t =
              this.options.hideOn instanceof Array
                ? this.options.hideOn[n]
                : this.options.hideOn),
            "string" == typeof e)
          )
            switch (e) {
              case "trigger":
                (t = t || "mouseout"), (o = this.triggerElement);
                break;
              case "tip":
                (t = t || "mouseover"), (o = this.container);
                break;
              case "target":
                (t = t || "mouseover"), (o = this.options.target);
                break;
              case "both":
                (t = t || "mouseout"),
          ...
          else (t = t || "mouseover"), (o = this.adapter.wrap(e));
          o && this.hideTriggers.push({ element: o, event: t, original: e }),
            hideTriggerElement2 &&
        ...
        for (d = [], r = 0, h = (p = this.hideTriggers).length; r < h; r++)
          (e = p[r]),
            d.push(
      ...
      (t.prototype._setupObservers = function () {
        ...
        for (
          r = 0,
            p = (n = 1 <= arguments.length ? __slice.call(arguments, 0) : [])
              .length;
          r < p;
          r++
        )
          if (
            ((o = n[r]),
            (e = !1),
            "-" === o.charAt(0) && ((e = !0), (o = o.substr(1))),
            !e !== this.currentObservers[o])
          )
            switch (
              ((this.currentObservers[o] = !e),
              (t = function () {
                var t, o, n;
                return (
                  (t = 1 <= arguments.length ? __slice.call(arguments, 0) : []),
                  e
                    ? (o = v.adapter).stopObserving.apply(o, t)
                    : (n = v.adapter).observe.apply(n, t)
                );
              }),
              o)
            ) {
              case "showing":
                for (a = 0, d = (f = this.hideTriggers).length; a < d; a++)
                  t((s = f[a]).element, s.event, this.bound.prepareToHide);
                t(
                  null != document.onresize ? document : window,
                  "resize",
              ...
              case "visible":
                for (
                  h = 0, u = (g = this.showTriggersWhenVisible).length;
                  h < u;
                  h++
                )
                ...
                break;
              case "hiding":
                for (l = 0, c = (m = this.showTriggers).length; l < c; l++)
      ...
      (t.prototype.prepareToShow = function () {
        if ((this._abortHiding(), this._abortShowing(), !this.visible))
          return (
      ...
      (t.prototype.show = function () {
        var e = this;
        if ((this._abortHiding(), !this.visible))
          return (
            this._clearTimeouts(),
      ...
      (t.prototype.prepareToHide = function () {
        if ((this._abortShowing(), this._abortHiding(), this.visible))
          return (
          ...
          return (
            ...
            this.defer(function () {
              ...
              return (
                ...
                t.setCss3Style(t.container, { transitionDuration: e + "s" }),
      ...
      (t.prototype.reposition = function () {
        var t,
          ...
          n = this;
        if (
          null != (t = this.getPosition()) &&
          ((e = this.options.stem),
          this.options.containInViewport &&
            ((t = (o = this._ensureViewportContainment(t)).position),
            (e = o.stem)),
          !this._positionsEqual(t, this.currentPosition))
        )
          return (
            this.options.stem && !e.eql(this.currentStem) && (this.redraw = !0),
            ...
            this.defer(function () {
              var t;
              return (
                ((t = n.adapter.unwrap(n.container)).style.visibility =
                  "hidden"),
                t.offsetHeight,
      ...
      (t.prototype.getPosition = function (t, e, o) {
        ...
        if (this.container)
          return (
            null == t && (t = this.options.tipJoint),
                ...
                e.right
                  ? null !=
                    ...
                    ? (a.left =
                        ...
                        (null != (u = window.pageXOffset)
                          ? u
                          : document.body.scrollLeft))
                    : (a.left += l.width)
                  : e.center && (a.left += Math.round(l.width / 2)),
                e.bottom
                  ? (a.top += l.height)
                  : e.middle && (a.top += Math.round(l.height / 2)),
                this.options.borderWidth &&
                  (this.options.tipJoint.left &&
                    (a.left += this.options.borderWidth),
                  this.options.tipJoint.right &&
                    (a.left -= this.options.borderWidth),
                  this.options.tipJoint.top
                    ? (a.top += this.options.borderWidth)
                    : this.options.tipJoint.bottom &&
                      (a.top -= this.options.borderWidth)))
              : (a = this.initialMousePosition
                  ? {
            ...
            this.options.autoOffset &&
              ...
              h &&
                (null == o && (o = this.options.stem),
                o.right ? (a.left -= h) : o.left && (a.left += h),
                o.bottom ? (a.top -= h) : o.top && (a.top += h))),
            (a.left += this.options.offset[0]),
            (a.top += this.options.offset[1]),
            t.right
              ? (a.left -= this.dimensions.width)
              : t.center && (a.left -= Math.round(this.dimensions.width / 2)),
            t.bottom
              ? (a.top -= this.dimensions.height)
              : t.middle && (a.top -= Math.round(this.dimensions.height / 2)),
            a
          );
      }),
      (t.prototype._ensureViewportContainment = function (e) {
        ...
        if (
          ((s = { position: e, stem: (l = this.options.stem) }),
          !this.visible || !e || (!(p = this._sticksOut(e))[0] && !p[1]))
        )
          return s;
        if (
          ((u = new t.Joint(this.options.tipJoint)),
        ...
        return o
          ? (this.options.stem && (l = u),
            (e = this.getPosition(u, d, l)),
            (r = !1),
            (a = !1),
            (n = this._sticksOut(e))[0] &&
              n[0] !== p[0] &&
              ((r = !0),
      ...
      (t.prototype._sticksOut = function (t) {
        var e, o, n, s;
        return (
          (o = this.adapter.scrollOffset()),
          (s = this.adapter.viewportDimensions()),
          (n = [!1, !1]),
          (e = [t.left - o[0], t.top - o[1]])[0] < 0
            ? (n[0] = this.STICKS_OUT_LEFT)
            : e[0] + this.dimensions.width > s.width &&
              (n[0] = this.STICKS_OUT_RIGHT),
          e[1] < 0
            ? (n[1] = this.STICKS_OUT_TOP)
            : e[1] + this.dimensions.height > s.height &&
              (n[1] = this.STICKS_OUT_BOTTOM),
          n
        );
      }),
      (t.prototype._draw = function () {
        ...
        if (this.backgroundCanvas && this.redraw) {
          if (
            ...
            for (
              b = 0, w = (_ = ["top", "right", "bottom", "left"]).length;
              b < w;
              b++
            )
              (m = _[b]), this.adapter.removeClass(this.container, "stem-" + m);
            this.adapter.addClass(
              this.container,
          ...
          return (
            ...
            __indexOf.call(this.options.hideTriggers, "closeButton") >= 0 &&
              ((l = new t.Joint(
                "top right" ===
                (null != (x = this.currentStem) ? x.toString() : void 0)
                  ? "top left"
                  : "top right"
              )),
              (p = [
            ...
            (h = [0, 0]),
            this.options.borderWidth &&
              ((a.width += 2 * this.options.borderWidth),
              (a.height += 2 * this.options.borderWidth),
              (h[0] -= this.options.borderWidth),
              (h[1] -= this.options.borderWidth)),
            this.options.shadow &&
              ((a.width += 2 * this.options.shadowBlur),
              (a.width += Math.max(
                0,
                this.options.shadowOffset[0] - 2 * this.options.shadowBlur
              )),
              (a.height += 2 * this.options.shadowBlur),
              (a.height += Math.max(
                0,
                this.options.shadowOffset[1] - 2 * this.options.shadowBlur
              )),
              (h[0] -= Math.max(
                0,
            ...
            this.currentStem &&
              (this.currentStem.left
                ? (r.left = this.options.stemLength)
                : this.currentStem.right && (r.right = this.options.stemLength),
              this.currentStem.top
                ? (r.top = this.options.stemLength)
                : this.currentStem.bottom &&
                  (r.bottom = this.options.stemLength)),
            l &&
              (l.left
                ? (r.left = Math.max(r.left, d[0]))
                : l.right && (r.right = Math.max(r.right, d[0])),
              l.top
                ? (r.top = Math.max(r.top, d[1]))
                : l.bottom && (r.bottom = Math.max(r.bottom, d[1]))),
            ...
            this.options.borderWidth
              ? ((u.strokeStyle = this.options.borderColor),
                (u.lineWidth = this.options.borderWidth))
              : ((y = this.options.stemLength), (v = this.options.stemBase)),
            null == v && (v = 0),
            (f = function (t, e, o) {
              if (
                (o &&
                  u.moveTo(
                    Math.max(v, T.options.borderRadius, p[0]) + 1 - g,
                    -g
                  ),
                e)
              )
            ...
            (c = function (t, e, o) {
              ...
              return t
                ? (u.lineTo(-v + g, 0 - g),
                  ...
                  u.lineTo(g, v - g))
                : e
                ? ((a = T.options.closeButtonOffset),
                  (r = p[0]),
                  o % 2 != 0 && ((a = [a[1], a[0]]), (r = p[1])),
                  ...
                  u.arc(
                    g - a[0],
                    -g + a[1],
                    T.options.closeButtonRadius,
                    -(Math.PI / 2 + n),
                    s,
                    !1
                  ))
                : (u.lineTo(-T.options.borderRadius + g, -g),
            ...
            (function () {
              ...
              for (
                m = [], o = d = 0, g = t.positions.length / 2;
                0 <= g ? d < g : d > g;
                o = 0 <= g ? ++d : --d
              )
                (r = 2 * o),
            ...
            u.save(),
            this.options.shadow &&
              ((u.shadowColor = this.options.shadowColor),
            ...
            l
              ? (T.options.closeButtonRadius,
                (e =
                  "top right" === l.toString()
                    ? [
                        (n = [
                          T.dimensions.width - T.options.closeButtonOffset[0],
                          T.options.closeButtonOffset[1],
                        ])[0] + g,
                        n[1] - g,
                      ]
                    : [
                        (n = [
                          T.options.closeButtonOffset[0],
                          T.options.closeButtonOffset[1],
                        ])[0] - g,
                        n[1] - g,
                      ]),
                ...
                T.adapter.css(T.closeButtonElement, {
                  ...
                  width:
                    T.options.closeButtonCrossSize +
                    2 * T.options.closeButtonLinkOverscan +
                    "px",
                  height:
                    T.options.closeButtonCrossSize +
                    2 * T.options.closeButtonLinkOverscan +
      ...
      (t.prototype._getPathStemMeasures = function (t, e, o) {
        ...
        return { stemLength: a, stemBase: Math.tan(s) * a * 2 };
      }),
      (t.prototype._getColor = function (t, e, o, n) {
        var s, r, a, h, l;
        if ((null == n && (n = !1), "string" == typeof o)) return o;
        for (
          r = n
      ...
      (t.prototype._ensureTriggerElement = function () {
        if (!this._triggerElementExists())
          return this.deactivate(), this._stopEnsureTriggerElement();
      }),
    ...
    Opentip.prototype.setCss3Style = function (t, e) {
      var o, n, s, r, a;
      for (o in ((t = this.adapter.unwrap(t)), (a = []), e))
        __hasProp.call(e, o) &&
          ((n = e[o]),
          null != t.style[o]
            ? a.push((t.style[o] = n))
            : a.push(
                function () {
                  var e, a, h;
                  for (h = [], e = 0, a = vendors.length; e < a; e++)
                    (s = vendors[e]),
    ...
    mouseMoved = function (t) {
      ...
      for (
        mousePosition = Opentip.adapter.mousePosition(t),
          s = [],
          o = 0,
          n = mousePositionObservers.length;
        o < n;
        o++
      )
        (e = mousePositionObservers[o]), s.push(e());
      return s;
    },
    ...
    Opentip._stopObservingMousePosition = function (t) {
      ...
      return (mousePositionObservers = (function () {
        var o, n, s;
        for (s = [], o = 0, n = mousePositionObservers.length; o < n; o++)
    ...
    Opentip.Joint = (function () {
      function t(t) {
        null != t &&
          (t instanceof Opentip.Joint && (t = t.toString()), this.set(t));
      }
      return (
        ...
        (t.prototype.setHorizontal = function (t) {
          var e, o, n, s, r, a, h;
          for (n = 0, r = (o = ["left", "center", "right"]).length; n < r; n++)
            (e = o[n]), ~t.indexOf(e) && (this.horizontal = e.toLowerCase());
          for (
            ...
            (e = o[s]), h.push((this[e] = this.horizontal === e ? e : void 0));
          return h;
        }),
        (t.prototype.setVertical = function (t) {
          var e, o, n, s, r, a, h;
          for (n = 0, r = (o = ["top", "middle", "bottom"]).length; n < r; n++)
            (e = o[n]), ~t.indexOf(e) && (this.vertical = e.toLowerCase());
          for (
            ...
            (e = o[s]), h.push((this[e] = this.vertical === e ? e : void 0));
          return h;
        }),
        ...
        (t.prototype.flip = function () {
          var t;
          return (
            (t = (Opentip.position[this.toString(!0)] + 4) % 8),
    ...
    Opentip.prototype._dimensionsEqual = function (t, e) {
      return (
        null != t && null != e && t.width === e.width && t.height === e.height
      );
    },
    Opentip.prototype.debug = function () {
      ...
      if (
        ...
        return t.unshift("#" + this.id + " |"), console.debug.apply(console, t);
    },
    Opentip.findElements = function () {
      ...
      for (
        p = [],
          a = 0,
          h = (l = (t = Opentip.adapter).findAll(document.body, "[data-ot]"))
            .length;
        a < h;
        a++
      ) {
        for (n in ((o = l[a]),
        (r = {}),
        ("" !== (e = t.data(o, "ot")) && "true" !== e && "yes" !== e) ||
          ((e = t.attr(o, "title")), t.attr(o, "title", "")),
        (e = e || ""),
        Opentip.styles.standard))
          null != (s = t.data(o, "ot" + Opentip.prototype.ucfirst(n))) &&
            ("yes" === s || "true" === s || "on" === s
              ? (s = !0)
              : ("no" !== s && "false" !== s && "off" !== s) || (s = !1),
            (r[n] = s));
    ...
    Opentip._abortShowingGroup = function (t, e) {
      var o, n, s, r, a;
      for (a = [], n = 0, s = (r = Opentip.tips).length; n < s; n++)
        (o = r[n]) !== e && o.options.group === t
          ? a.push(o._abortShowing())
          : a.push(void 0);
      return a;
    },
    ...
    Opentip.addAdapter = function (t) {
      if (((Opentip.adapters[t.name] = t), firstAdapter))
        return (
          (Opentip.adapter = t),
    ...
    Opentip.position = {},
    i = _i = 0,
    _len = (_ref = Opentip.positions).length;
  _i < _len;
  i = ++_i
)
    ...
    return (
        ...
        if (
          ...
          (s = function (e) {
            if ("readystatechange" !== e.type || "complete" === o.readyState)
              return (
                ("load" === e.type ? d : o)[h](a + e.type, s, !1),
                n ? void 0 : ((n = !0), t())
              );
          }),
          (r = function () {
      ...
      (o.prototype.wrap = function (t) {
        ...
        return (
          t
            ? "string" == typeof t
              ? (t = (t = this.find(document.body, t)) ? [t] : [])
              : t instanceof NodeList
              ? (t = (function () {
                  var o, n, s;
                  for (s = [], o = 0, n = t.length; o < n; o++)
                    (e = t[o]), s.push(e);
                  return s;
                })())
      ...
      (o.prototype.attr = function (t, e, o) {
        return 3 === arguments.length
          ? this.unwrap(t).setAttribute(e, o)
          : this.unwrap(t).getAttribute(e);
      }),
      (e = 0),
      (t = {}),
      (o.prototype.data = function (o, n, s) {
        var r;
        return (
          (r = this.attr(o, "data-id")) ||
            ((r = ++e), this.attr(o, "data-id", r), (t[r] = {})),
          3 === arguments.length
            ? (t[r][n] = s)
            : (null != (s = t[r][n]) ||
                ((s = this.attr(o, "data-" + Opentip.prototype.dasherize(n))) &&
                  (t[r][n] = s)),
              s)
        );
      }),
      ...
      (o.prototype.append = function (t, e) {
        var o;
        return (o = this.unwrap(e)), this.unwrap(t).appendChild(o);
      }),
      ...
      (o.prototype.css = function (t, e) {
        var o, n, s;
        for (o in ((t = this.unwrap(this.wrap(t))), (s = []), e))
          __hasProp.call(e, o) && ((n = e[o]), s.push((t.style[o] = n)));
        return s;
      }),
      ...
      (o.prototype.mousePosition = function (t) {
        var e;
        if (
          ((e = { x: 0, y: 0 }), null == t && (t = window.event), null != t)
        ) {
          try {
            t.pageX || t.pageY
      ...
      (o.prototype.offset = function (t) {
        var e;
        for (
          e = { top: (t = this.unwrap(t)).offsetTop, left: t.offsetLeft };
          (t = t.offsetParent);
      ...
      (o.prototype.ajax = function (t) {
        var e, o, n;
        if (null == t.url) throw Error("No url provided");
              ...
              try {
                200 === e.status
                  ...
                  : "function" == typeof t.onError &&
                    t.onError("Server responded with status " + e.status);
              } catch (o) {
                "function" == typeof t.onError && t.onError(o.message);
              }
              return "function" == typeof t.onComplete
                ? t.onComplete()
                : void 0;
            }
          }),
          e.open(
            null != (o = null != (n = t.method) ? n.toUpperCase() : void 0)
              ? o
              : "GET",
            t.url
          ),
      ...
      (o.prototype.clone = function (t) {
        var e, o, n;
        for (e in ((o = {}), t))
          __hasProp.call(t, e) && ((n = t[e]), (o[e] = n));
        return o;
      }),
      (o.prototype.extend = function () {
        ...
        for (
          n = arguments[0],
            r = 0,
            a = (o = 2 <= arguments.length ? __slice.call(arguments, 1) : [])
              .length;
          r < a;
          r++
        )
          for (t in (e = o[r]))
            __hasProp.call(e, t) && ((s = e[t]), (n[t] = s));
        return n;
      }),
      o
    );
    ...
    (function () {
      ...
      var h = Array.prototype.slice,
        l = {
          ...
          init_: function (t) {
            ...
            for (
              var o = t.getElementsByTagName("canvas"), n = 0;
              n < o.length;
              n++
            )
      ...
      function g(t, e) {
        for (
          ...
          for (var s = 0; s < 3; s++) {
            for (var r = 0, a = 0; a < 3; a++) r += t[n][a] * e[a][s];
            o[n][s] = r;
          }
        return o;
      }
      ...
      function v(t) {
        ...
        if ("rgb" == (t = String(t)).substring(0, 3)) {
          ...
          e = "#";
          for (var a = 0; a < 3; a++) e += u[Number(r[a])];
      ...
      function _(t, e, o) {
        if (
          (function (t) {
            for (var e = 0; e < 3; e++)
              for (var o = 0; o < 2; o++)
                if (!isFinite(t[e][o]) || isNaN(t[e][o])) return !1;
            return !0;
          })(e) &&
          ((t.m_ = e), o)
        ) {
      ...
      (b.clearRect = function () {
        ...
        (b.moveTo = function (t, e) {
          ...
          this.currentPath_.push({ type: "moveTo", x: o.x, y: o.y }),
            (this.currentX_ = o.x),
            (this.currentY_ = o.y);
        }),
        (b.lineTo = function (t, e) {
          var o = this.getCoords_(t, e);
          this.currentPath_.push({ type: "lineTo", x: o.x, y: o.y }),
            (this.currentX_ = o.x),
            (this.currentY_ = o.y);
        }),
        ...
        (b.createLinearGradient = function (t, e, o, n) {
          ...
          return (s.x0_ = t), (s.y0_ = e), (s.x1_ = o), (s.y1_ = n), s;
        }),
        ...
        (b.drawImage = function (o, n) {
          var s,
            ...
            d,
            u,
            c = o.runtimeStyle.width,
            f = o.runtimeStyle.height;
          (o.runtimeStyle.width = "auto"), (o.runtimeStyle.height = "auto");
          var g = o.width,
            m = o.height;
          if (
            ((o.runtimeStyle.width = c),
          ...
          } else y.push("top:", e(v.y / 10), "px;left:", e(v.x / 10), "px;");
          y.push(
            ' ">',
            '<g_vml_:image src="',
            o.src,
        ...
        (b.stroke = function (o) {
          ...
          for (
            var h = { x: null, y: null }, l = { x: null, y: null }, p = 0;
            p < this.currentPath_.length;
            p++
          ) {
            ...
            switch (d.type) {
              ...
              case "wa":
                n.push(
                  ...
                  d.type,
                  " ",
                  e(d.x - this.arcScaleX_ * d.radius),
                  ",",
                  e(d.y - this.arcScaleY_ * d.radius),
                  " ",
                  e(d.x + this.arcScaleX_ * d.radius),
                  ",",
                  e(d.y + this.arcScaleY_ * d.radius),
          ...
          if ((n.push(' ">'), o)) {
            if ("object" == typeof this.fillStyle) {
              ...
              if ("gradient" == u.type_) {
                var y,
                  b = u.x0_ / this.arcScaleX_,
                  w = u.y0_ / this.arcScaleY_,
                  _ = u.x1_ / this.arcScaleX_,
                  x = u.y1_ / this.arcScaleY_,
                  C = this.getCoords_(b, w),
                  T = this.getCoords_(_, x);
                (c = (180 * Math.atan2(T.x - C.x, T.y - C.y)) / Math.PI) < 0 &&
                  (c += 360),
                  c < 1e-6 && (c = 0);
              } else {
                ...
                var S = l.x - h.x,
                  O = l.y - h.y;
                (f = { x: (C.x - h.x) / S, y: (C.y - h.y) / O }),
                  (S /= 10 * this.arcScaleX_),
                  (O /= 10 * this.arcScaleY_);
                var E = t.max(S, O);
                (g = (2 * u.r0_) / E), (m = (2 * u.r1_) / E - g);
              }
              var P = u.colors_;
              P.sort(function (t, e) {
            ...
            } else n.push('<g_vml_:fill color="', r, '" opacity="', a, '" />');
          } else {
        ...
        if (
          ...
          (l.add = function () {
            var t,
              ...
              n = e.length,
              s = !1;
            do -1 === a(this, (t = e[o] + "")) && (this.push(t), (s = !0));
            while (++o < n);
          ...
          var d = { get: p, enumerable: !0, configurable: !0 };
          try {
            o.defineProperty(e, "classList", d);
          } catch (u) {
            -2146823252 === u.number &&
              ((d.enumerable = !1), o.defineProperty(e, "classList", d));
          }
        } else
    ...
    if (t.length) {
      ...
      if (e.length)
        for (var o = 0; o < e.length; o++)
          e[o].innerHTML == t.text()
            ? e[o].parentElement.classList.add("active")
            : e[o].parentElement.classList.remove("active");
    }
  })(),
